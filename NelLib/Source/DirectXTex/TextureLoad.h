...
#ifdef _X86_
#ifdef _DEBUG
#pragma comment(lib, "../NelLib/Source/DirectXTex/Win32/Debug/DirectXTex.lib")
#else
#pragma comment(lib, "../NelLib/Source/DirectXTex/Win32/Release/DirectXTex.lib")
#endif
#else
#ifdef _DEBUG
#pragma comment(lib, "../NelLib/Source/DirectXTex/x64/Debug/DirectXTex.lib")
#else
#pragma comment(lib, "../NelLib/Source/DirectXTex/x64/Release/DirectXTex.lib")
#endif
#endif
